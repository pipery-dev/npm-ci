# Pipery Node.js/npm CI Component

Reusable GitLab CI/CD component for complete Node.js/npm CI pipeline with structured logging.

## Overview

This component provides a complete CI/CD pipeline for Node.js/npm projects:
- SAST scanning
...
```yaml
include:
  - component: $CI_SERVER_FQDN/pipery-dev/pipery-npm-ci/catalog-resources/pipery-npm-ci@main
...
| NODE_VERSION | 20 | Node.js/npm runtime version |
